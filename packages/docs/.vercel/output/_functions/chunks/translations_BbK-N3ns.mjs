import { o as objectType, t as dateType, i as arrayType, j as stringType, v as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, w as escape$1, u as unescapeHTML, a as renderTemplate, x as renderUniqueStylesheet, y as renderScriptElement, z as createHeadAndContent, r as renderComponent, A as AstroUserError } from './astro/server_m2Kd7PvH.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C-aSXz3g.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_XF2L4Pog.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DAHu-JfE.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_B8nV_xZU.mjs');
...
const starlightConfig = {"description":"Cross-language schema converter: Zod to Pydantic and TypeScript","social":[{"icon":"github","label":"GitHub","href":"https://github.com/iamtemi/schemabridge"},{"icon":"npm","label":"npm","href":"https://www.npmjs.com/package/schemabridge"},{"icon":"seti:python","label":"Python","href":"https://pypi.org/project/schemabridge/"},{"icon":"linkedin","label":"LinkedIn","href":"https://www.linkedin.com/in/temi-adenuga/"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Start Here","translations":{},"collapsed":false,"items":[{"label":"Introduction","translations":{},"slug":"introduction","attrs":{}},{"label":"Getting Started","translations":{},"slug":"getting-started","attrs":{}},{"label":"API Reference","translations":{},"slug":"api","attrs":{}},{"label":"CLI","translations":{},"slug":"cli","attrs":{}},{"label":"Folder Conversion","translations":{},"slug":"folder-conversion","attrs":{}},{"label":"Use Cases","translations":{},"slug":"use-cases","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"SchemaBridge"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///Users/temi/codebase/schemabridge/packages/docs/","srcDir":"file:///Users/temi/codebase/schemabridge/packages/docs/src/","trailingSlash":"ignore"};
