...
Generated files include a stable marker comment, such as `# Generated by SchemaBridge. Do not edit.` for Python. `clean` only deletes stale files with this marker.
